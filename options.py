...
class Options():
    ...
    def initialize(self):
        ...
        parser.add_argument('--apt', default='georg-binaural', choices=['georg-binaural', 'georg-binaural-06', 'georg-binaural-09'], type=str)
    ...
    def parse(self):
        ...
        self.opt.max_len = {"georg-binaural": 708, "georg-binaural-06": 708, "georg-binaural-09": 708}  # Maximum length of the input spectrograms, used for padding
